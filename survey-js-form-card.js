...
class SurveyCard extends LitElement {
  ...
  pageCssLogic(options) {
    ...
    for (let ele of this.config.surveyjs_json.pages[this.survey.currentPageNo]
      .elements) {
      console.log(
        "Page details",
        this.config.surveyjs_json.pages[this.survey.currentPageNo],
        this.survey.currentPageNo,
      ...
      if (
        ...
        console.log(classKey, classValue, "Classes");
