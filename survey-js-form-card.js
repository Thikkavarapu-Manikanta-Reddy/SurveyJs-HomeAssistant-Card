...
const customCssObject1 = {
  rating: {
    item: "rating-item",
  },
};

const customCssObject2 = {
  rating: {
...
// loadCSS("https://unpkg.com/nouislider/dist/nouislider.min.css");
...
class SurveyCard extends LitElement {
  ...
  constructSurveyUI() {
    ...
    console.log(
      ...
      this.config,
      noUiSlider,
      Survey.Serializer.getProperties("nouislider")
    );

    setTimeout(() => {
      Survey.Serializer.addProperties("nouislider", [
        {
          name: "step:number",
          category: "slider",
          categoryIndex: 1,
    ...
    console.log("Survey Model", this.survey, this.survey.visiblePages);

    this.survey.css = customCssObject1;

    console.log("FEDRf", this.config.surveyjs_json);

    // setTimeout(() => {
    //   this.survey.css = customCssObject2;
    // }, 3000);
  ...
  pageCssLogic(options) {
    ...
    // this.config.surveyjs_json.pages.forEach((page) => {});

    // if (options.question.getType() === "rating") {
    //   const classes = options.cssClasses;
    //   console.log(classes.item);
    //   classes.item = "sd-rating__item";
    // }
  }
  ...
  render() {
    return html`
      ...
      ${console.log("KKKK", this.config.customCss)}
    ...
    */
        ...
        @font-face {
          ...
          unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02C6, U+02DA,
            U+02DC, U+2000-206F, U+2074, U+20AC, U+2212, U+2215, U+E0FF, U+EFFD,
            U+F000;
        }
        ...
        .sv-popup--overlay.sv-popup--overlay .sv-popup__body-content {
          ...
          padding: calc(3 * var(--base-unit, 8px))
            calc(2 * var(--base-unit, 8px)) calc(2 * var(--base-unit, 8px));
        ...
        .sv-save-data_root {
          ...
          transform: translateX(-50%)
            translateY(calc(3 * var(--base-unit, 8px)));
        ...
        .sd-panel__footer {
          box-sizing: border-box;
          padding-left: calc(
            var(--sd-base-padding) - 3 * var(--base-unit, 8px)
          );
          margin-left: calc(-1 * var(--sd-base-padding));
          width: calc(100% + 2 * var(--sd-base-padding));
          margin-bottom: calc(
        ...
        .sd-body--responsive .sd-page {
          padding: calc(5 * var(--base-unit, 8px))
            var(--sd-page-vertical-padding) calc(2 * var(--base-unit, 8px));
        }
        ...
        .sd-title.sd-container-modern__title {
          display: flex;
          align-items: center;
          padding: var(--sd-page-vertical-padding)
            var(--sd-page-vertical-padding);
          overflow: auto;
          font-family: var(--font-family, var(--font-family));
        ...
        [style*="direction: rtl"] .sd-dropdown {
          background-position: left calc(1.5 * var(--base-unit, 8px)) top 50%,
            0 0;
        }
        ...
        .sd-paneldynamic__buttons-container {
          display: flex;
          align-items: center;
          padding: calc(var(--sd-base-vertical-padding) - var(--base-unit, 8px))
            0;
        }
        ...
        .sd-root-modern--mobile
          .sd-body.sd-body--with-timer.sd-body--responsive {
          max-width: initial;
          margin-left: 0;
          margin-right: 0;
        }
        ...
        .sd-root-modern.sd-root-modern--mobile
          .sd-table__cell:not(.sd-matrix__cell):not(
            .sd-table__cell--actions
          ):not(.sd-table__cell--row-text)::before {
          padding-top: calc(2 * var(--base-unit, 8px));
          padding-bottom: calc(1 * var(--base-unit, 8px));
